...
/**
 * Menampilkan dialog konfirmasi SweetAlert untuk aksi penghapusan.
 * @param title Judul dialog
 * @param text Pesan dialog
 * @param confirmButtonText Teks tombol konfirmasi
 */
...
/**
 * Menampilkan notifikasi sukses sederhana (Toast like) menggunakan SweetAlert.
 */
